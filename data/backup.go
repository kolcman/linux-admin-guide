...
var BackupSection = Section{
	...
	Items: []Item{
		...
		{Type: TypeHeader, Value: "🗜️ Сжатие одного файла"},
		{Type: TypeTip, Value: "gzip / bzip2 / xz (lzma) сжимают файл → *.gz / *.bz2 / *.xz. tar — склейка многих файлов в один archive.tar; tar.gz = tar + gzip."},
		{Type: TypeKey, Key: "gzip / gunzip", Desc: ".gz"},
		{Type: TypeKey, Key: "bzip2 / bunzip2", Desc: ".bz2"},
		{Type: TypeKey, Key: "xz / unxz", Desc: ".xz (lzma / unlzma — то же семейство)"},
		{Type: TypeCmd, Value: "gzip file.txt", Desc: "→ file.txt.gz (исходник обычно убирает)"},
		{Type: TypeCmd, Value: "gunzip file.txt.gz", Desc: "распаковать .gz"},
		{Type: TypeCmd, Value: "bzip2 file.txt", Desc: "→ file.txt.bz2"},
		{Type: TypeCmd, Value: "bunzip2 file.txt.bz2", Desc: "распаковать .bz2"},
		{Type: TypeCmd, Value: "xz file.txt", Desc: "→ file.txt.xz"},
		{Type: TypeCmd, Value: "unxz file.txt.xz", Desc: "распаковать .xz"},
		...
		{Type: TypeKey, Key: "-j", Desc: "bzip2 (.tar.bz2)"},
		{Type: TypeKey, Key: "-J", Desc: "xz (.tar.xz)"},
		{Type: TypeKey, Key: "--exclude", Desc: "не класть в архив (можно несколько раз)"},
		{Type: TypeCmd, Value: "tar -cf archive.tar folder/", Desc: "архив без сжатия"},
